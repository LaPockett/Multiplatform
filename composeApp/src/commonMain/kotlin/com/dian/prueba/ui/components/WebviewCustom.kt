...
fun WebViewHome (
    ...
    logger.debug(headers.toString(), "WebViewHome")
...
fun WebViewAccount (
    ...
    val headers = WebViewHeaderManager.getHeaders()
    logger.debug(headers.toString(), "WebViewAccount")
...
fun WebViewCart (
    ...
    val headers = WebViewHeaderManager.getHeaders()
    logger.debug(headers.toString(), "WebViewCart")
...
fun WebViewSearch (
    ...
    val headers = WebViewHeaderManager.getHeaders()
    logger.debug(headers.toString(), "WebViewSearch")
