...
fun WebViewCart (
    ...
    WebView(
        state = rememberWebViewState("https://www.amazon.es/gp/cart/view.html?ref_=nav_cart"),
        modifier = modifier
    )
}
...
fun WebViewSearch (
    ...
    WebView(
        state = rememberWebViewState("https://www.amazon.es/gp/bestsellers/?ref_=nav_cs_bestsellers"),
        modifier = modifier
    )
}
