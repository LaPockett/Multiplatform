...
import com.dian.prueba.Centralization.WebViewHeaderManager
...
fun WebViewHome (
    ...
    println("DIAN LOG: HEADER USADOS Home"+headers)
...
fun WebViewAccount (
    ...
    val headers = WebViewHeaderManager.getHeaders()
    println("DIAN LOGh: HEADER USADOS Account "+headers)
...
fun WebViewCart (
    ...
    val headers = WebViewHeaderManager.getHeaders()
    println("DIAN LOG: HEADER USADOS Cart "+headers)
...
fun WebViewSearch (
    ...
    val headers = WebViewHeaderManager.getHeaders()
    println("DIAN LOG: HEADER USADOS Search "+headers)
